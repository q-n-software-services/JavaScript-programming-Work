...
<title>Lahori Village Restaurant</title>
...
<body>
<div class="header">
    <img src="images/lahori village.jpeg" class="img-fluid" style="height:200px; width: 1400;">
</div>
        ...
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
              <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal3">Add Product</button></li>
              <li><hr class="dropdown-divider"></li>
              <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal4">Remove Product</button></li>
              <li><hr class="dropdown-divider"></li>
              <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal5">Edit Product</button></li>
              <li><hr class="dropdown-divider"></li>
              <li><button class="dropdown-item" id="generate_results">Generate Results</button></li>
            </ul>
          </li>
          
        </ul>
        
          <button style="margin-right:1cm;" class="btn btn-outline-success" type="submit" onclick="checkout()" id="create" data-bs-toggle="modal" data-bs-target="#staticBackdrop">CHECKOUT</button>
...
<div class="container">
    <div class="row row-cols-4" id="menu">
...
<!-- Modal -->
<div class="modal fade .modal-dialog-centered modal-dialog-scrollable" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog">
  <div class="modal-content"> 
    <div class="modal-header">
      <h1 class="modal-title" id="staticBackdropLabel" style="text-align: center; background-color: gold; border-radius: 1cm; border-left: 1cm; border-right: 1cm;">               CHECKOUT   </h1>
    ...
    <div class="modal-body" id="modal-body">
      ...
      <div class="form-floating mb-3">
        <input type="number" class="form-control" id="amount" placeholder="amountPaid">
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-success" id="payoutBtn" data-bs-toggle="modal" data-bs-target="#staticBackdrop2"><a href="#"  style="color: white;  text-decoration: none;">Payout</a></button>
    </div>
  </div>
</div>
</div>
...
<!-- Modal -->
<div class="modal fade .modal-dialog-centered modal-dialog-scrollable" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog">
  <div class="modal-content"> 
    <div class="modal-header">
      <h1 class="modal-title" id="staticBackdropLabel2" style="text-align: center; background-color: gold; border-radius: 1cm;border-left: 1cm; border-right: 1cm;">               Cash   </h1>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    ...
    <div class="modal-footer">
      <button type="button" id='okay'  class="btn btn-success" data-bs-dismiss="modal"><a href="#" style="color: white;  text-decoration: none;">Okay</a></button>
    </div>
  </div>
</div>
</div>
...
<!-- Modal#3 -->
<div class="modal fade .modal-dialog-centered modal-dialog-scrollable" id="modal3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog">
  <div class="modal-content"> 
    <div class="modal-header">
      <h1 class="modal-title" id="staticBackdropLabel2" style="text-align: center; background-color: rgb(54, 245, 48); border-radius: 1cm;border-left: 1cm; border-right: 1cm;">               Add Product   </h1>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body" id="modal-body3">
      ...
      <form class="row g-3">
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" id="inputImage" value="images/121212.jpeg">
        </div>
        <div class="col-12">
          <label for="inputAddress2" class="form-label">Details</label>
          <input type="text" class="form-control" id="inputDetails" placeholder="Anything about the product">
        </div>
        <div class="col-md-6">
    ...
    <div class="modal-footer">
      <button type="button" data-bs-dismiss="modal" class="btn btn-success" onclick="proceed_add()">Submit</button>
    </div>
  </div>
</div>
</div>
...
<!-- Modal#4 -->
<div class="modal fade .modal-dialog-centered modal-dialog-scrollable" id="modal4" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog">
  <div class="modal-content"> 
    <div class="modal-header">
      <h1 class="modal-title" id="staticBackdropLabel2" style="text-align: center; background-color: rgb(243, 35, 35); border-radius: 1cm;border-left: 1cm; border-right: 1cm;">               Remove Product   </h1>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
...
<!-- Modal#5 -->
<div class="modal fade .modal-dialog-centered modal-dialog-scrollable" id="modal5" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog">
  <div class="modal-content"> 
    <div class="modal-header">
      <h1 class="modal-title" id="staticBackdropLabel2" style="text-align: center; background-color: rgb(34, 238, 221); border-radius: 1cm; border-left: 1cm; border-right: 1cm;">               Edit Product   </h1>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    ...
    <div class="modal-footer" id="modal-footer5">
